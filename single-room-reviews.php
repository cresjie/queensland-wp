        ...
        <div id="review_form_wrapper">
            <div id="review_form">
                <?php
                    ...
                    $comment_form['comment_field'] .= '<p class="comment-form-comment"><label for="comment">' . __( 'Your Review', 'tp-hotel-booking' ) . '</label><textarea class="full-width" id="comment" name="comment" cols="45" rows="8" aria-required="true"></textarea></p>';
