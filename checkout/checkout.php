            ...
            <table class="hb_table table">
                ...
                <tr class="hb_advance_tax">
                    ...
                    <td class="text-right">
                        ...
                        <?php } ?>
                        <span class=""><?php echo apply_filters( 'hotel_booking_cart_tax_display', hb_format_price( $cart->total - $cart->sub_total ) ); // abs( $tax * 100 ) . '%' ?></span>
                    </td>
                </tr>
                <?php } ?>
                ...
                <?php if( $advance_payment = $cart->advance_payment ) { ?>
                    ...
                    <?php if( hb_get_advance_payment() < 100 ) { ?>
                        <tr class="hb_payment_all">
                            <td colspan="6" class="border-right-1">
                            </td>
                            <td class="text-right">
                                <label class="">
